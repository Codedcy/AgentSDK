...
| R5 | in progress (Tasks 1-4 complete) | Trace, attribution, analysis, and installed-wheel reference | Task 4 focused gates and public smoke pass; Task 5 release-candidate gate pending |
...
- Active plan: `docs/superpowers/plans/2026-07-17-agent-sdk-v0.1-r5-trace-release.md`;
  R5 Tasks 1-4 are implemented and Task 5 is the next release-candidate gate.
