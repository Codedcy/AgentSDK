...
2026-07-22 author rewrite recovery: verified complete bundle `.git/backups/pre-author-rewrite-2026-07-22.bundle`, SHA256 `8DCCD5CD7553FA97B15CE124F721895A865C05997912BD44FA9D6442BC0A1835`; remote force-push remains explicitly pending.
...
2026-07-22 author rewrite cleanup: temporary `refs/original` and `refs/rewrites` removed after bundle and mapping verification; `origin/master` intentionally remains on the pre-rewrite history until explicit force-with-lease approval.
